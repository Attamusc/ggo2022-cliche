...
class Velocity {
	...
	inline function set_frict(v)
		return frictX = frictY = v;

	public var dirX(get, never): Int;

	inline function get_dirX()
		return M.sign(dx);

	public var dirY(get, never): Int;

	inline function get_dirY()
		return M.sign(dy);
