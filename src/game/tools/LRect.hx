...
class LRect {
	...
	**/
	...
	inline function get_pxLeft()
		return topLeft.levelXi;

	inline function set_pxLeft(v: Int) {
		topLeft.levelX = v;
		normalize();
		return v;
	}

	inline function get_pxTop()
		return topLeft.levelYi;

	inline function set_pxTop(v: Int) {
		topLeft.levelY = v;
		normalize();
		return v;
	}

	inline function get_pxBottom()
		return bottomRight.levelYi;

	inline function set_pxBottom(v: Int) {
		bottomRight.levelY = v;
		normalize();
		return v;
	}

	inline function get_pxRight()
		return bottomRight.levelXi;

	inline function set_pxRight(v: Int) {
		bottomRight.levelX = v;
		normalize();
		return v;
	}

	inline function get_pxWid()
		return bottomRight.levelXi - topLeft.levelXi + 1;

	inline function set_pxWid(v) {
		bottomRight.levelX = topLeft.levelXi + v;
		normalize();
		return v;
	}

	inline function get_pxHei()
		return bottomRight.levelYi - topLeft.levelYi + 1;

	inline function set_pxHei(v) {
		bottomRight.levelY = topLeft.levelYi + v;
		normalize();
		return v;
	}

	inline function get_cLeft()
		return topLeft.cx;

	inline function set_cLeft(v: Int) {
		topLeft.cx = v;
		topLeft.xr = 0;
		normalize();
		return v;
	...
	inline function get_cTop()
		return topLeft.cy;

	inline function set_cTop(v: Int) {
		topLeft.cy = v;
		topLeft.yr = 0;
		normalize();
		return v;
	...
	inline function get_cRight()
		return bottomRight.cx;

	inline function set_cRight(v: Int) {
		bottomRight.cx = v;
		bottomRight.xr = 0.999;
		normalize();
		return v;
	}

	inline function get_cBottom()
		return bottomRight.cy;

	inline function set_cBottom(v: Int) {
		bottomRight.cy = v;
		bottomRight.yr = 0.999;
		normalize();
		return v;
	}

	inline function get_cWid()
		return bottomRight.cx - topLeft.cx + 1;

	inline function set_cWid(v: Int) {
		bottomRight.cx = topLeft.cx + v - 1;
		bottomRight.xr = 0.999;
		normalize();
		return v;
	}
	...
	inline function get_cHei()
		return bottomRight.cy - topLeft.cy + 1;

	inline function set_cHei(v: Int) {
		bottomRight.cy = topLeft.cy + v - 1;
		bottomRight.yr = 0.999;
		normalize();
		return v;
	}
